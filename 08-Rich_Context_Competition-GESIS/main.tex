...
\begin{document}
    ...
    \input{sections-old/1-0-intro}
    \input{sections-old/2-0-data-and-prepro}
    \input{sections-old/3-0-dataset-extraction}
    \input{sections-old/4-0-research-method-extraction}
    \input{sections-old/5-0-research-field-classification}
    %\input{sections-old/6-0-operating-instructions}
    %\input{sections/rest-to-delete}
    \input{back}
\end{document}
